...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <header>
        <div class="container">
            <h2>Asadulloh<span> Ruziev</span></h2>
            <nav class="desktop-nav">
                <a href="{{ route('games.create')}}">Create</a>
                <a href="{{ route('games.index')}}">Show</a>
            </nav>
    ...
    <main>
        <section class="container">
            ...
            <button type="button" class="btn">
                <span class="btn__text"><a href="https://github.com/AsadullohRuziev?tab=repositories"> GitHub</a></span>
